module @embedding attributes {ada300.rxops_codegen = "full", ada300.rxops_placeholder_ops = 1 : i64, ada300.rxops_supported_ops = 6 : i64, module.FLOPs = 0 : i64, module.addr_mode = "basic", module.asymmetric = false, module.chip = "ada300", module.coeff_addr = 0 : i64, module.coeff_size = 1017118720 : i64, module.cores = 1 : i64, module.devices = 1 : i64, module.high_precision = false, module.mode = "F16", module.neuron_addr = 0 : i64, module.neuron_size = 12599296 : i64, module.platform = "LLM_QUANTIZED", module.q_group_size = 0 : i64, module.q_symmetric = false, module.state = "TPU_ADDRESSED", module.top_run_mode = "STATIC", module.weight_file = "embedding_tpu_addressed_ada300_f16_weight.npz", tpu.gmem_bytes = 536870912 : i64, tpu.sram_bank_bytes = 262144 : i64, tpu.sram_bank_count = 5 : i64, tpu.target = "ada300", tpu.weight_memory_bytes = 268435456 : i64} {
  ...
  func.func @main(%arg0: memref<1x1024xsi32, strided<[?, ?], offset: ?>>) -> memref<1x1024x2048xf16> {
    ...
    %alloc_0 = memref.alloc() : memref<1x1024xsi32>
    memref.copy %arg0, %alloc_0 : memref<1x1024xsi32, strided<[?, ?], offset: ?>> to memref<1x1024xsi32>
    ...
    %intptr_3 = memref.extract_aligned_pointer_as_index %alloc_0 : memref<1x1024xsi32> -> index
    %10 = arith.index_cast %intptr_3 : index to i64
    %11 = llvm.inttoptr %10 : i64 to !llvm.ptr
    %12 = call @rxops_bridge_gather_nd(%7, %9, %11, %5, %4, %3, %2, %1, %1, %1, %1, %1, %0, %1, %1, %1, %1, %1, %0, %2, %1, %1, %1) {ada300.rxops.keep = true} : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64) -> i32
    %cast = memref.cast %alloc_1 : memref<1x1024x2048xf16> to memref<1x1024x2048xf16, strided<[?, ?, ?], offset: ?>>
    memref.dealloc %alloc : memref<248320x2048xf16>
    return %alloc_1 : memref<1x1024x2048xf16>
  }
}
